...
export const LogoUpload: Component<LogoUploadProps> = (props) => {
  ...
  return (
    <div class="flex flex-col gap-1.5">
      ...
      >
        <FileUpload.Dropzone class="group flex w-full cursor-pointer flex-col items-center justify-center rounded-card border-2 border-dashed border-border bg-muted p-4 transition-colors hover:border-primary/50 data-[dragging]:border-primary data-[dragging]:bg-primary/5">
          <Show
            when={props.logo}
            fallback={
              <>
          ...
          >
            <div class="flex items-center gap-3">
              <img
                ...
                class="h-16 w-16 rounded-card object-contain"
              />
