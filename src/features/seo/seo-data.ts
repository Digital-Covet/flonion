...
export const businessInfo: BusinessInfo = {
  ...
  reviewCount: 87,
  reviewLink:
    "https://search.google.com/local/writereview?placeid=ChIJGblnVa655zsRtRfkePjHE8E",
};
...
export const keywordSuggestions: KeywordSuggestion[] = [
  ...
  {
    id: "k3",
    keyword: "thai restaurant downtown",
    searchVolume: "high",
    relevance: 88,
    currentlyUsed: true,
  },
  {
    id: "k4",
    keyword: "asian noodles delivery",
    searchVolume: "medium",
    relevance: 82,
    currentlyUsed: false,
  },
...
export const seoActionItems: ActionItemData[] = [
  ...
  },
  {
    ...
    description:
      "Your menu items section is underrepresented. Add photos of popular dishes.",
    status: "completed",
    icon: ImagePlus,
